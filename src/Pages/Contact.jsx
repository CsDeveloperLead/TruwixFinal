...
const Contact = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center min-h-screen gap-10  bg-[#0e0811]"  style={{
      ...
      >
        ...
        <div className="bg-[#0e0811] hidden md:flex shadow-2xl text-[#E1BBFB] flex-col gap-8 justify-center px-8 h-[500px] absolute left-[-120px]"  style={{
          boxShadow: "0 4px 20px rgba(181, 122, 221, 0.7)", // Purple shadow
          borderRadius: "20px",
        }}>
